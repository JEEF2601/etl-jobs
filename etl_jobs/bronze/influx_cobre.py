...
def main() -> None:
    spark = None
    try:
        spark = build_spark_session("influx_cobre_etl")
        ...
        overwrite_partitioned_dataset(spark, df_clean, target_path, "date", "bronze")
        print("ETL influx_cobre completed successfully.")
    finally:
